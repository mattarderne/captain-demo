...
/* Orders view: the crew's reply is hidden. It stays in the DOM (ids and textContent unchanged for
   both e2e suites — see renderLog) so only the painting changes. A standalone crew EVENT is a
   different element and is never hidden. */
.hud-log-list[data-view="orders"] .hud-log-entry:not(.hud-log-crew-entry) .hud-log-crew {
  display: none;
}
.hud-log-crew {
  color: #b9f6c4;
